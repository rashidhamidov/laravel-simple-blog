    ...
    <div class="container-fluid">
        ...
        <div class="row">
            @if (session('status'))
                ...
                @endif
            <form action="/admin/video_save" method="POST" enctype="multipart/form-data">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
            <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Video ekleme</h5>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="url" required="required" type="text" class="form-control" id="fname" placeholder="Açıklama">
                            </textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="border-top">
                    <div class="card-body">
                        <button type="submit" class="btn btn-success">Ekle</button>  <a href="/admin/video_listesi/" class="btn btn-secondary">Geri </a>
                    </div>
                </div>
            </div>
        </form>
