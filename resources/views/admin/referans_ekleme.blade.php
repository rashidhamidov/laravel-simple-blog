    ...
    <div class="container-fluid">
        ...
        <div class="row">
            @if (session('status'))
                ...
                @endif
            <form action="/admin/referans_save" method="POST" enctype="multipart/form-data">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
            <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Referans ekleme</h5>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="Url" required="required" type="text" class="form-control" id="fname" placeholder="Url">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="custom-file">
                                ...
                                <input required style="visibility:hidden;"id="uploadImage" type="file" name="resim" onchange="PreviewImage();" />
                ...
                <div class="border-top">
                    <div class="card-body">
                        <button type="submit" class="btn btn-success">Ekle</button>  <a href="/admin/referans_listesi/" class="btn btn-secondary">Geri </a>
                    </div>
                </div>
            </div>
        </form>
