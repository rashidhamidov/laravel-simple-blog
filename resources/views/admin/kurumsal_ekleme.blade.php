    ...
    <div class="container-fluid">
        ...
        <div class="row">
            @if (session('status'))
                ...
                @endif
            <form action="/admin/kurumsal_save" method="POST" enctype="multipart/form-data">
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
            <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Kurumsal ekleme</h5>
                ...
                <div class="border-top">
                    <div class="card-body">
                        <button type="submit" class="btn btn-success">Ekle</button>  <a href="/admin/kurumsal_listesi/" class="btn btn-secondary">Geri </a>
                    </div>
                </div>
            </div>
        </form>
