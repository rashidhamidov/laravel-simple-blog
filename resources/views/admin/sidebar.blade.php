          ...
          <div class="scroll-sidebar">
              ...
              <nav class="sidebar-nav">
                  <ul id="sidebarnav" class="p-t-30">
                      ...
                      <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="far fa-object-group"></i><span class="hide-menu">İçerik Yönetimi </span></a>
                          <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="/admin/icerik_ekleme" class="sidebar-link"><i class="far fa-plus-square"></i><span class="hide-menu"> İçerik Ekleme </span></a></li>
                              <li class="sidebar-item"><a href="/admin/icerik_listesi" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> İçerik Listesi </span></a></li>
