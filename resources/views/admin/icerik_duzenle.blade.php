...
<div class="page-wrapper">
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">İçerik</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                <h5 class="card-title">İçerik düzenleme : {{$icerik[0]->title}}</h5>
                    <div class="form-group row">
                        <label class="col-md-3 m-t-15">İçerik Tipi</label>
                        <div class="col-md-9">
                            ...
                            <select name="category" required="required"class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                ...
                                <option value="{{$icerik_category[0]->id}}" selected >{{$icerik_category[0]->title}}</option>
                                @foreach ($category as $rs)
                                @if($rs->id != $icerik_category[0]->id)
                    ...
                    <div class="form-group row">
                        <label class="col-md-3">İçerik Resmi</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3" for="disabledTextInput">İçerik Detayı</label>
                        <div class="col-md-9">
