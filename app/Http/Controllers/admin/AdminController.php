...
{   
    ...
    public function icerik_ekleme(){
        ...
        return view('admin.icerik_ekleme', ['category' => $category]);
    }
    ...
    public function icerik_save (Request $request){
            ...
            return redirect('/admin/icerik_listesi')->with('success',"İçerik başarıyla eklendi");
        }catch(Exception $e){
    ...
    public function icerik_duzenle_save (Request $request,$id){
       ...
       if($request->hasfile('resim')){
        ...
        try{
            DB::update('update content set category_id = ?,keywords=?,description=?,title=?,content=?,status=?,tarih=? where id = ?',
            [$data['category'],$data['keywords'],$data['description'],$data['title'],$data['content'],$data['status'],date("F j, Y, g:i a"),$id ]);
        
            return redirect('/admin/icerik_listesi')->with('success',"İçerik başarıyla güncellendi");
            }catch(Exception $e){
                return redirect('/admin/icerik_listesi')->with('failed',"İçerik güncellenemedi");
            }
            
         }
       try{
            DB::update('update content set category_id = ?,keywords=?,description=?,title=?,content=?,image=?,status=?,tarih=? where id = ?',
            [$data['category'],$data['keywords'],$data['description'],$data['title'],$data['content'],$name,$data['status'],date("F j, Y, g:i a"),$id ]);
                ...
                public function ayar_duzenle() {
                    ...
                    public function ayar_duzenle_save (Request $request,$id){
                       ...
                       if($request->hasfile('logo')){
                        ...
                        try{
                            DB::update('update setting set title=?,keywords=?,description=?,phone = ?,email=?,facebook=?,instagram=?,twitter=?,contact=?,google_map=?,company=?,status=?,hours=? where id = ?',
                            [$data['title'],$data['keywords'],$data['description'],$data['phone'],$data['email'],$data['facebook'],$data['instagram'],$data['twitter'],$data['contact'],$data['google_map'],$data['company'],$data['status'],
                            $data['hours'],
                            $id ]);
                       ...
                       try{
                            DB::update('update setting set title=?,keywords=?,description=?,phone = ?,email=?,facebook=?,instagram=?,twitter=?,contact=?,google_map=?,company=?,status=?,logo=? where id = ?',
                            [$data['title'],$data['keywords'],$data['description'],$data['phone'],$data['email'],$data['facebook'],$data['instagram'],$data['twitter'],$data['contact'],$data['google_map'],$data['company'],$data['status'],$name,$id ]);
