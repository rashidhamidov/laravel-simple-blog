...
Route::get('/admin/seminer', 'App\Http\Controllers\admin\AdminController@seminer');
...
Route::get('/{slug}','App\Http\Controllers\home\HomeController@kurumsal_sayfa' );
Route::get('/icerik/{id}','App\Http\Controllers\home\HomeController@icerik_sayfa' );
Route::get('/categories/{id}','App\Http\Controllers\home\HomeController@kategori_sayfa' );
Route::get('/categories','App\Http\Controllers\home\HomeController@kategori' );
